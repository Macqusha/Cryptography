...
namespace Labs
{
    public partial class Form09 : Form
    {
        ...
        {
            InitializeComponent();
            f9_chooseHashFun.Text = "MD5";
            f9_chooseHashFunRecieved.Text = "MD5";
        }
        ...
        private void f9_buttonNextPrimeQ_Click(object sender, EventArgs e)
        {
            f9_textQ.Text = new string(f9_textQ.Text.Where(t => char.IsDigit(t)).ToArray());

            BigInteger ParamQ;
            if (f9_textQ.TextLength > 0)
                ParamQ = BigInteger.Parse(f9_textQ.Text);
            else
                ParamQ = 0;
            ...
            f9_textQ.Text = Convert.ToString(ParamQ);
        }
        ...
        private void f9_textParam_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void f9_buttonClearParams_Click(object sender, EventArgs e)
        {
            f9_chooseHashFun.Enabled = true;
            f9_textP.ReadOnly = false;
            f9_textQ.ReadOnly = false;
            f9_textN.Text = "";
            f9_buttonNextPrimeP.Enabled = true;
            f9_buttonNextPrimeQ.Enabled = true;
            f9_buttonSetParams.Enabled = true;
            f9_buttonClearParams.Enabled = false;
            //очистить все поля внизу, установить кнопки на нужные режимы (сбросить все)
            f9_textSecretKey.Text = "";
            f9_textOpenKey.Text = "";
            f9_button_GetRandomSecret.Enabled = true;
            f9_button_SetSecretKey.Enabled = true;
            f9_button_ClearSecretKey.Enabled = false;
            f9_buttonSign.Enabled = false;

            f9_textOpenKeyRecieved.Text = "";
            f9_textNRecieved.Text = "";
            f9_textBoxSignRecieved.Text = "";
            f9_textVerificationResult.Text = "";
            f9_textBoxSign.Text = "";
        }
        ...
        private void f9_button_ClearSecretKey_Click(object sender, EventArgs e)
        {
            f9_textBoxSign.Text = "";
            f9_textSecretKey.Text = "";
            f9_textOpenKey.Text = "";
        ...
        private void f9_buttonSendSign_Click(object sender, EventArgs e)
        {
            f9_textOpenKeyRecieved.Text = f9_textOpenKey.Text;
            f9_textNRecieved.Text = f9_textN.Text;
            f9_textBoxSignRecieved.Text = f9_textBoxSign.Text;
            f9_chooseHashFunRecieved.Text = f9_chooseHashFun.Text;
        }
        private void f9_buttonSign_Click(object sender, EventArgs e)
        {
            ...
            if (Sign > 0)
            {
                if (y > N) MessageBox.Show(("Подпись небезопасна: используйте значение N, большее h(m) = " + Convert.ToString(y)), "Предупреждение");
        ...
        private void f9_textANY_Recieved_Param_TextChanged(object sender, EventArgs e)
        {
            f9_textVerificationResult.Text = "";
        }
    }
